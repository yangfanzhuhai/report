...
We built a data service \acrshort{api} to provide historical, current, and reference bus journey times for a given hour on a given day of the week. To demonstrate the potential use of our \acrshort{api}, we designed a web application to allow passengers to browse these predicted bus jounrney times conveniently.
\end{abstract}
