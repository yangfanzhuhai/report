...
\textsc{\large MEng Individual Project Report}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries Active Delay Warning Transport Application}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
